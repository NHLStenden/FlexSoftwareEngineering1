...
namespace MathProblems
{
    class Program
    {
        ...
        {
            return SomKGVRecursive(a, a);
        }

        static int SomKGVRecursive(int a, int b)
        {
            if (b == 0) return 0;
            int kgv = KleinsteGemeneVeelvoud(a, b);
            return kgv + SomKGVRecursive(a, b - 1);
        }
        ...
        {
            int ggd = GrootsteGemenedeler(a, b);
            int kgv = Math.Abs(a * b) / ggd;
        ...
        {
            if (a == b) { return a; }
            if (a > b)  { return GrootsteGemenedeler(a - b, b); }
            else        { return GrootsteGemenedeler(a, b - a); }
        }
    }// class Program
}//MathProblems
